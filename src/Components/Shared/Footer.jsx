        ...
        <div>
            <footer className="footer p-10 bg-gray-600  text-white">
                ...
                <div>
                    ...
                    <a className="link link-hover">Contact : 01789512433</a>
                    <a className="link link-hover">Email : nazmos789@gmail.com</a>
                    <a className="link link-hover">Address : Dhaka,Bangladesh</a>
                    <a className="link link-hover">Hotline : 999-003-8787</a>
                </div>
                <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-gray-600 text-white border-gray-600">
                <div className="items-center grid-flow-col">
                    ...
                    <p>Hero Toys Ltd. <br />Colection of Awesome Action Figure</p>
                </div>
